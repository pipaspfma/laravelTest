...
<head>
    ...
    <link rel="stylesheet" href="{{ URL::asset('src/dist/css/bootstrap.min.css') }}">
    <!-- <link rel="stylesheet" href="assets/font-awesome/css/font-awesome.min.css"> -->
    <link rel="stylesheet" href="http://maxcdn.bootstrapcdn.com/font-awesome/4.2.0/css/font-awesome.min.css">
    <link rel="stylesheet" href="{{ URL::asset('src/css/form-elements.css') }}">
    ...
    <link rel="shortcut icon" href="{{ URL::asset('src/ico/favicon.png') }}">
    <link rel="apple-touch-icon-precomposed" sizes="144x144" href="{{ URL::asset('src/ico/apple-touch-icon-144-precomposed.png') }}">
    <link rel="apple-touch-icon-precomposed" sizes="114x114" href="{{ URL::asset('src/ico/apple-touch-icon-114-precomposed.png') }}">
    <link rel="apple-touch-icon-precomposed" sizes="72x72" href="{{ URL::asset('src/ico/apple-touch-icon-72-precomposed.png') }}">
    <link rel="apple-touch-icon-precomposed" href="{{ URL::asset('src/ico/apple-touch-icon-57-precomposed.png') }}">
...
<!-- Javascript -->
<script src="{{ URL::asset('src/js/jquery-1.11.1.min.js') }}"></script>
<script src="{{ URL::asset('src/dist/js/bootstrap.min.js') }}"></script>
<script src="{{ URL::asset('src/js/jquery.backstretch.min.js') }}"></script>
<script src="{{ URL::asset('src/js/retina-1.1.0.min.js') }}"></script>
<script src="{{ URL::asset('src/js/scripts.js') }}"></script>

<!--[if lt IE 10]>
<script src="{{ URL::asset('src/js/placeholder.js') }}"></script>
<![endif]-->
